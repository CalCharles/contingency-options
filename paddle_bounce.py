...
if __name__ == "__main__":
    ...
    # python paddle_bounce.py --model-form population --optimizer-form CMAES --record-rollouts "data/action/" --train-edge "Paddle->Ball" --num-stack 1 --train --num-iters 16 --state-forms prox vel bounds bounds --state-names Paddle Ball Paddle Ball --base-node Paddle --changepoint-dir ./data/paddlegraph --lr 5e-3 --behavior-policy esp --reward-form bounce --gamma .9 --init-form xnorm --base-form vector --num-population 10 --sample-duration 100 --warm-up 0 --log-interval 1 --scale 1 --OoO-eval --done-swapping 30 --reward-check 10 --gpu 1 --sample-schedule 12 --key-dim 128 --num-layers 1 --buffer-clip 50 --greedy-epsilon .05
    args = get_args()
